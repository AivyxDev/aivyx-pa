...
pub const PA_PROMPT_DELEGATION: &str = concat!(
    ...
    "  - nonagon-coordinator: orchestrates multi-agent workflows\n",
    "  - nonagon-researcher: gathers information, evaluates sources\n",
    "  - nonagon-analyst: data analysis, pattern recognition, quantified findings\n",
    "  - nonagon-coder: writes and tests code, manages git\n",
    "  - nonagon-reviewer: code review, security audit, architectural assessment\n",
    "  - nonagon-writer: documentation, tutorials, technical writing\n",
    "  - nonagon-planner: task decomposition, complexity estimation, planning\n",
    "  - nonagon-guardian: security monitoring, capability validation, audit\n",
    "  - nonagon-executor: shell commands, file management, deployment\n\n",
    "Use team_delegate when a task would benefit from multiple perspectives or ",
    "specialized expertise. The nonagon-coordinator agent receives your task and orchestrates ",
